...
//#1
int64 nChainStartTime = 1525231046;
...
const string strMessageMagic = "GCMFCoin Signed Message:\n";
...
{
//    int64 nRewardCoinYear;//pingbi
//    nRewardCoinYear = 0.05 * MAX_MINT_PROOF_OF_STAKE;
...
//#1
static const int64 nTargetTimespan = 24 * 60;
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in GCMFCoin
    bool fStrictPayToScriptHash = true; // Always active in GCMFCoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "GCMFCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        //#1
        const char* pszTimestamp = "GCMFCoin created by SMITH 2017/07/06";
        CTransaction txNew;
        ...
        block.nVersion = 1;
        block.nTime    = nChainStartTime + 90;
       ...
       // printf("block.nNonce = %u \n", block.nNonce);
		block.print();
        //#1
        assert(block.hashMerkleRoot == uint256("0x5958857093febc1765a3ae791e53205e243795262d039eb9385789cd3ec4f967"));
